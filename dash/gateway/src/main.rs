    ...
    async fn try_main() -> Result<()> {
        ...
        HttpServer::new(move || {
            ...
            App::new()
                ...
                .service(crate::routes::job::delete)
                .service(crate::routes::job::get)
                .service(crate::routes::job::get_list)
                .service(crate::routes::job::get_list_with_function_name)
                .service(crate::routes::job::get_stream_logs)
                .service(crate::routes::job::post)
                .service(crate::routes::job::post_restart)
