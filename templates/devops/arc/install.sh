...
HELM_CHART_DEFAULT="https://actions-runner-controller.github.io/actions-runner-controller"
NAMESPACE_DEFAULT="devops-arc"
...
helm upgrade --install "github-actions-runner-controller" \
